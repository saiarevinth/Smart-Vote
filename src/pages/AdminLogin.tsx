...
const AdminLogin = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Check if the Google account email is in your allowed admin list
      const adminEmails = ['saiarev2005@gmail.com',]; // Add your admin emails here
      if (adminEmails.includes(result.user.email || '')) {
        ...
        await auth.signOut();
        toast.error('Unauthorized access. Please use an admin account.');
      }
    } catch (error: any) {
